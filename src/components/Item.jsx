...
export default function Item() {
  ...
  return (
    <div className="my-[50px] max-w-screen-2xl text-neutral-900 bg-neutral-300 dark:bg-neutral-900 dark:text-neutral-200">
      <div className="flex flex-wrap items-center justify-center gap-10 text-xs">
        {countries.slice(0, visibleCount).map((country, index) => (
          <div
            key={index}
            className="h-[250px] w-[250px] p-3 flex flex-col gap-3 mb-4 shadow-2xl text-neutral-900 bg-neutral-300 dark:bg-neutral-700 dark:text-neutral-200"
          >
            <img
              className="h-2/3"
